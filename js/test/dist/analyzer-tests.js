...
describe("Analyzer", function() {
  ...
  it("Should call analyze", function() {
  ...
  it("Should treat hyphenated words as single tokens", function() {
    ...
    let feats1 = [
      { pos: "nn", tokens: "mother-in-law", phones: "m-ah-dh-er-ih-n-l-ao", stresses: "1/0-0-1", syllables: "m-ah/dh-er/ih-n/l-ao" },
  ...
  it("Should call phonesToStress", function() {
    expect(RiTa.analyzer.phonesToStress()).eq(void 0);
  ...
  it("Should call computePhones", function() {
    expect(RiTa.analyzer.computePhones("leo")).eql(["l", "iy", "ow"]);
    expect(RiTa.analyzer.computePhones()).eq(void 0);
    expect(RiTa.analyzer.computePhones(".")).eq(void 0);
    expect(RiTa.analyzer.computePhones("")).eq(void 0);
    expect(RiTa.analyzer.computePhones(",")).eq(void 0);
    expect(RiTa.analyzer.computePhones("\u4F60\u597D", { silent: true })).eq(void 0);
    expect(RiTa.analyzer.computePhones("K\xFCnste", { silent: true })).eq(void 0);
